...
// 
...
public class NamePairClassifier extends SparseNetworkLearner
{
  ...
  static
  {
    _lcFilePath = NamePairClassifier.class.getResource("NamePairClassifier.lc");
    _lexFilePath = NamePairClassifier.class.getResource("NamePairClassifier.lex");
  }
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      if (_lcFilePath == null)
      {
        throw new RuntimeException("Can't locate NamePairClassifier.lc in the class path.");
      }
      if (_lexFilePath == null)
      {
        throw new RuntimeException("Can't locate NamePairClassifier.lc in the class path.");
      }
      instance = (NamePairClassifier) Learner.readLearner(_lcFilePath);
  ...
  public static NamePairClassifier instance;

  public static NamePairClassifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private NamePairClassifier(boolean b)
  {
    super(new SparseAveragedPerceptron(.1, 0, 20));
    containingPackage = "edu.illinois.cs.cogcomp.ner.lbjava";
    name = "NamePairClassifier";
    setEncoding(null);
    setLabeler(new WordMatch());
    setExtractor(new NamePairClassifier$$1());
    isClone = false;
  }
  ...
  public NamePairClassifier()
  {
    super("edu.illinois.cs.cogcomp.ner.lbjava.NamePairClassifier");
    isClone = true;
  }

  public NamePairClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public NamePairClassifier(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(NamePairClassifier.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(NamePairClassifier.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(NamePairClassifier.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.ner.lbjava";
      name = "NamePairClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof WordPair || example instanceof Object[]))
      {
        String type = example == null ? "null" : example.getClass().getName();
        System.err.println("Classifier 'NamePairClassifier(WordPair)' defined on line 89 of NamePairClassifier.lbj received '" + type + "' as input.");
  ...
  public void learn(Object[] examples)
  {
    if (isClone)
    {
      if (!(examples instanceof WordPair[] || examples instanceof Object[][]))
      {
  ...
  public Feature featureValue(Object __example)
  {
    if (isClone)
    {
      if (!(__example instanceof WordPair || __example instanceof Object[]))
      {
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.ner.lbjava.NamePairClassifier \\");
    ...
    NamePairClassifier classifier = new NamePairClassifier();
  ...
  public int hashCode() { return "NamePairClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof NamePairClassifier; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new NamePairClassifier(false).getParameters()); }
  }
}
