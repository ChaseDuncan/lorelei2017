...
// F1B88000000000000000B2A4D4CC1507DCB4179CC2E21D80FCF2A49084CCC225820D450B1D558A6582A4D292D2AC350D5FD4C29C0DB4C4A26D820DB2E284CC3DB4F4D290E4D4ECFCB41D0D450D55820DB2A4D434717D4B658A5000732489E9D5000000
...
public class EndDist extends Classifier
{
  public EndDist()
  {
  ...
  public double realValue(Object __example)
  {
    if (!(__example instanceof WordPair))
    {
      ...
      System.err.println("Classifier 'EndDist(WordPair)' defined on line 14 of NamePairClassifier.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "EndDist".hashCode(); }
  public boolean equals(Object o) { return o instanceof EndDist; }
}
